...
def test_build_fact_select_resolves_sks_and_measures():
    ...
    sql = build_fact_select(
        ...
        surrogate_name="po_sk",
        surrogate_keys=["po_number", "po_line"],
        date_column="order_date",
        dims=dims,
        measures=[{"name": "order_qty"}, {"name": "line_amount", "expr": "order_qty * unit_price"}],
    )
